...
<div id="layout-wrapper">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user" style="background: #0ab39c;">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="/azienda/profilo"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profilo</span></a>
    ...
    <!-- ========== App Menu ========== -->
    <div class="app-menu navbar-menu" style="background: linear-gradient(-90deg, #0ab39c 10%, #405189);;border: none;">
        <!-- LOGO -->
        <div class="navbar-brand-box">
            <!-- Dark Logo-->
            <a href="/admin/index" class="logo logo-dark">
                    <span class="logo-sm">
                            <img src="/base_icon_white_background.png" alt="" height="22">
                    </span>
                <span class="logo-lg">
            ...
            $logo = $azienda->immagine ?? 'base_logo_white_background.png';
            ?>
    ...
    <span class="logo-sm">
        <img src="/{{ $logo }}" alt="" height="22">
                ...
                <span class="logo-lg">
        <img src="/{{ $logo }}" style="margin:0 auto;display:block;width:100%;margin-top:20px;">
    </span>
            </a>
        ...
        @include('azienda.common.sidebar')
