        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Task Chiusi</h4>
                ...
                <?php foreach ($lavori as $l) { ?>
                    <div class="col-md-6 lavoro-card">
                        <div class="card" >
                            ...
                            <?php $task = DB::table('task')->where('id_lavoro', $l->id)->where('id_dipendente', $utente->id)->where('stato', 0)->get(); ?>
                            <div class="card-body">
                                <?php if(!$task->isEmpty()){ ?>
                                    <?php foreach ($task as $t){ ?>
                                        <?php $dipendente = DB::table('utenti')->where('id', $t->id_dipendente)->first(); ?>
                                        <div style="background-color: rgba(39, 174, 96, 0.3); position: relative; margin-bottom: 7px; border-radius: 10px; padding: 10px; <?php if($t->id_dipendente == '' || $t->id_dipendente == null){ ?> border: 1px solid yellow; <?php }else{ ?>border: 1px solid white;<?php } ?>">
                                            ...
                                            <div class="m-0 mt-5 pt-3" style="border-top: 1px solid white">
                                                ...
                                                <div style="display: flex; justify-content: space-between">
                                                    ...
                                                    <div style="display: flex; justify-content: right">
                                                        <button class="btn btn-sm btn-primary add-btn me-2" onclick="info_task_chiuso(<?php echo $t->id ?>)">
