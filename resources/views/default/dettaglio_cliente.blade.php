                        ...
                        <ul class="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link fs-14" data-bs-toggle="tab" href="#activities" role="tab">
                                    <i class="ri-list-unordered d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block">Leads</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                                ...
                                                <?php foreach($preventivi as $p){ if($p->status == 2 || $p->status == 3) $totale_valore += $p->totale;  ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php } ?>
                                                            <?php if($p->status == 3){ ?>
                                                            <span clas  s="badge bg-success">Completato</span>
                                                            <?php } ?>
                                                            <?php if($p->status == 4){ ?>
                                            ...
                                            <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a style="float:left;margin-left:5px;" onclick="crea_preventivo_lead(<?php echo $l->id_utente ?>,<?php echo $l->id ?>)" class="btn btn-sm btn-success">+</a>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div>
                                <label class="form-label">Data Canone<b style="color:red">*</b></label>
                                <input type="date" name="data_canone" class="form-control" value="<?php echo $p->data_canone ?>" placeholder="Data" required />
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <div>
                                <label class="form-label">Totale <b style="color:red">*</b></label>
                                <input type="number" step="1" name="totale" value="0" value="<?php echo $l->totale ?>" class="form-control" placeholder="Totale" required />
                            </div>
                        </div>
