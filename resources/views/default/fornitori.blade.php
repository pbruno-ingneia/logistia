            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Fornitori</h5>
                            </div>
                            <div class="card-body">
                                <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php foreach($fornitori as $f){ ?>
                                            <tr>
                                                <td><img style="max-width:60px;height: auto;" src="<?php echo URL::asset($f->immagine) ?>"></td>
                                                <td><?php echo $f->nome ?></td>
                                                <td><?php echo $f->cognome ?></td>
                                                <td><?php echo $f->ragione_sociale ?></td>
                                                <td><?php echo $f->email ?></td>
                                                <td><span class="badge bg-primary">&euro; <?php echo number_format($f->budget,2,'.','') ?></span></td>
                                                <td>
                                                    <a style="float:left" href="/admin/dettaglio_utente/<?php echo $f->id ?>" class="btn btn-sm btn-success">V</a>
                                                    <a style="float:left;margin-left:5px;" onclick="modifica(<?php echo $f->id ?>)" class="btn btn-sm btn-primary">M</a>
            ...
            <form enctype="multipart/form-data" method="post">
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div>
                                <label class="form-label">Nome <b style="color:red">*</b></label>
                                <input type="text" name="nome" class="form-control" value="<?php echo $f->nome ?>" placeholder="Nome" required />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div>
                                <label class="form-label">Cognome <b style="color:red">*</b></label>
                                <input type="text" name="cognome" class="form-control" value="<?php echo $f->cognome ?>" placeholder="Cognome" required />
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div>
                                <label for="company_name-field" class="form-label">Ragione Sociale <b style="color:red">*</b></label>
                                <input type="text" name="ragione_sociale" class="form-control" value="<?php echo $f->ragione_sociale ?>" placeholder="Ragione Sociale" required />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div>
                                <label  class="form-label">Email <b style="color:red">*</b></label>
                                <input type="email" name="email" class="form-control" value="<?php echo $f->email ?>" placeholder="Email" required />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div>
                                <label  class="form-label">Password <b style="color:red">*</b></label>
                                <input type="password" name="password" class="form-control" value="<?php echo $f->password ?>" placeholder="Password" required/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div>
                                <label class="form-label">Indirizzo</label>
                                <input type="text" name="indirizzo" class="form-control" value="<?php echo $f->indirizzo ?>" placeholder="Indirizzo" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div>
                                <label class="form-label">Comune</label>
                                <input type="text" name="comune" class="form-control" value="<?php echo $f->comune ?>" placeholder="Comune" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div>
                                <label class="form-label">Provincia</label>
                                <input type="text" name="provincia" class="form-control" value="<?php echo $f->provincia ?>" placeholder="Provincia" />
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <div class="hstack gap-2 justify-content-end">
                        ...
                        <input style="float:left;" type="submit" class="btn btn-primary" id="add-btn" name="invia_credenziali" value="Invia Credenziali" >
