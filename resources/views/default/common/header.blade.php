...
<div id="layout-wrapper">
    <header id="page-topbar">
        <div class="layout-width">
            <div class="navbar-header" style="background: #004b87;">
                <div class="d-flex">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user" style="background: #004b87;">
    ...
    <!-- ========== App Menu ========== -->
    <div class="app-menu navbar-menu" style="background: #004b87;border: none;">
        <!-- LOGO -->
        <div class="navbar-brand-box">
            ...
            <a href="/admin/index" class="logo logo-dark">
                ...
                <span class="logo-lg">
                            <img src="/logo.jpg" style="margin:0 auto;display:block;width:100%;margin-top:20px;">
                    </span>
            </a>
            <!-- Light Logo-->
