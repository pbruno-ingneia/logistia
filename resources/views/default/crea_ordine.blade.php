                            ...
                            <div class="table-responsive">
                                <table class="invoice-table table table-borderless table-nowrap mb-0">
                                    ...
                                    <tr id="1" class="product">
                                        ...
                                        <td class="text-start">
                                            <div class="mb-2">
                                                <input type="text" class="form-control bg-light border-0" name="products[0][nome_prodotto]" id="productName-1" placeholder="Product Name" required />
                                                <div class="invalid-feedback">
                                        ...
                                        <td class="text-end">
                                            <div>
                                                <input type="text" class="form-control bg-light border-0 product-line-price" name="products[0][prezzo_totale]" id="productPrice-1" placeholder="$0.00" readonly />
                                            </div>
                                        </td>
                                        <td class="product-removal">
                                            <a href="javascript:void(0)" class="btn btn-success" onclick="removeProduct(1)">Delete</a>
                                        </td>
                                    </tr>
                                    </tbody>
                                            ...
                                            <table class="table table-borderless table-sm table-nowrap align-middle mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:150px;">
                                                        <input type="text" class="form-control bg-light border-0" name="imponibile" id="cart-subtotal" placeholder="$0.00" readonly />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Iva</th>
                                                ...
                                                <tr class="border-top border-top-dashed">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control bg-light border-0" name="costo_totale" id="cart-total" placeholder="$0.00" readonly />
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
