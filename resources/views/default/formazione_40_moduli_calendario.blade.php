            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Calendario Modulo <?php echo $m->descrizione ?> (<?php echo $m->ore ?> ore)</h4>
                            ...
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <button class="btn btn-info add-btn" onclick="aggiungi();">
                                        <i class="ri-add-fill me-1 align-bottom"></i>Aggiungi Calendario
                                    </button>
                                </div>
                                <!--
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php $totale_ore = 0; ?>
                                        <?php foreach($calendario as $c){ $totale_ore += $c->ore; ?>
                                            <tr>
                                                <td><?php echo $c->id ?></td>
                                                <td><?php echo $c->timestamp_inizio ?></td>
                                                <td><?php echo $c->timestamp_fine ?></td>
                                                <td><?php echo $c->ore ?></td>
                                                <td>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <a style="float:left" onclick="modifica(<?php echo $c->id ?>)" class="btn btn-sm btn-primary">M</a>
                                                            <form method="post" onsubmit="return confirm('Vuoi Eliminare questo calendario ?')">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            <div class="modal-header bg-soft-info p-3">
                <h5 class="modal-title" id="exampleModalLabel">Aggiungi Calendario</h5>
            ...
            <form class="tablelist-form" autocomplete="off" enctype="multipart/form-data" method="post">
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <div>
                                <label class="form-label">Timestamp Inizio <b style="color:red">*</b></label>
                                <input type="datetime-local" name="timestamp_inizio" class="form-control" placeholder="Timestamp Inizio" required />
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div>
                                <label class="form-label">TimeStamp Fine</label>
                                <input type="datetime-local" name="timestamp_fine" class="form-control" placeholder="Codice" />
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <div class="hstack gap-2 justify-content-end">
                        ...
                        <input type="hidden" name="id_corso" value="<?php echo $m->id_corso ?>">
...
<?php foreach($calendario as $c){ ?>
    ...
    <div class="modal fade" id="modal_modifica_<?php echo $c->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content border-0">
            <div class="modal-header bg-soft-info p-3">
                <h5 class="modal-title" id="exampleModalLabel">Modiica Calendario</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
            </div>
            <form class="tablelist-form" autocomplete="off" enctype="multipart/form-data" method="post">
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <div>
                                <label class="form-label">Timestamp Inizio <b style="color:red">*</b></label>
                                <input type="datetime-local" name="timestamp_inizio" value="<?php echo $c->timestamp_inizio ?>" class="form-control" placeholder="Timestamp Inizio" required />
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div>
                                <label class="form-label">TimeStamp Fine</label>
                                <input type="datetime-local" name="timestamp_fine" value="<?php echo $c->timestamp_fine ?>" class="form-control" placeholder="Codice" />
                            </div>
                        </div>
