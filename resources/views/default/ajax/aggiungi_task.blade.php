...
<div class="modal fade" id="modal_aggiungi_task_<?php echo $l->id ?>" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form class="tablelist-form" autocomplete="off" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="id_dipendente" class="form-control"  >
                                <option selected disabled>-- Seleziona un dipendente --</option>
                        ...
                        <div class="col-md-12">
                            <div>
                                <label class="form-label">Alllegato</label>
                ...
                <div class="modal-footer">
                    <div class="hstack gap-2 justify-content-end">
                        ...
                        <input type="hidden"  name="id_lavoro" value="{{$l->id}}" >
                        <input type="submit" class="btn btn-success" id="add-btn" name="aggiungi_task" value="Aggiungi" >
