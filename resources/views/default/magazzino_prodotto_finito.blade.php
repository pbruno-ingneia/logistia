        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Magazzino Prodotto Finito</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="scroll-horizontal" class="table table-bordered table-hover datatable" style="width:100%">
                                ...
                                <tr>
                                    <td><img style="max-width: 60px; background: white;" src="<?php echo URL::asset($a->immagine) ?>"></td>
                                    <td><?php echo $a->titolo ?><br><small><?php echo ($a->tipologia == 0)?'Prodotto Finito':'Materiale' ?></small></td>
