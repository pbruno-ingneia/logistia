                                ...
                                <div class="table-responsive">
                                    <table class="invoice-table table table-borderless table-nowrap mb-0">
                                        ...
                                        <tr id="{{ $index + 1 }}" class="product">
                                            ...
                                            <td class="text-start">
                                                <div class="mb-2">
                                                    <select class="form-control bg-light border-0" id="productSelect-{{ $index + 1 }}" onchange="updateProductNameField({{ $index + 1 }})" required>
                                            ...
                                            <td>
                                                <select style="width: 50px" class="form-control" id="unitOfMeasure" name="products[{{ $index }}][um]" required>
...
<script>
    ...
    function new_link() {
        ...
        <tr id="${productCount}" class="product">
            ...
            <td class="text-start">
                <div class="mb-2">
                    <select class="form-control bg-light border-0" id="productSelect-${productCount}" onchange="updateProductNameField(${productCount})" required>
                <option value="">Seleziona un Prodotto</option>
                 @foreach($prodotti_finiti as $prodotto)
