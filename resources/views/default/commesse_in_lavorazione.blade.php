                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <button class="btn btn-success add-btn" onclick="aggiungi_task(<?php echo $l->id ?>);">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                        <form class="mx-2" method="post" onsubmit="return confirm('Vuoi Terminare questa Commessa ?')">
                                        ...
                                        <form method="post" onsubmit="return doubleConfirm();">
                                            <input type="hidden" name="archivia_lavoro" value="{{$l->id}}">
                                            <input type="hidden" name="id_archiviazione" value="{{$l->id}}">
...
<script type="text/javascript">
    ...
    function doubleConfirm() {
        if (confirm('Vuoi Archiviare questa Commessa?')) {
            var confirmationText = prompt('Per favore, scrivi "archivia" per confermare:');
            if (confirmationText && confirmationText.toLowerCase() === 'archivia') {
                return true; // Submit the form
            } else {
                alert('Conferma non valida. Per favore, scrivi "archivia" per confermare.');
                return false;
            }
        }
        return false;
